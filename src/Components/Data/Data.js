...
class Garbage extends Component {
  ...
  componentWillMount() {
    this.props.seedCards(specialDeck)
  }
...
const addDispatcher = (connector, ref) => ({
  seedCards(cards) {
    //p2/caCrOjoGxEamloCVeLGfcDtJDS92
    //p1/TlgEFiyrHcYPFJKjVPaqYBzWWrs1
    cards.forEach(card =>{
...
export default firebaseConnect(null, addDispatcher)(Garbage)
